...
def copy_shapes(source_obj, target_obj):
    ...
    #pm.matchTransform(target_obj, source_obj, pos=True, rot=True, scl=True)
    #pm.makeIdentity(source_obj, apply=True, t=1, r=1, s=1, n=0, pn=1) #is this needed?
   # pm.makeIdentity(target_obj, apply=True, t=1, r=1, s=1, n=0, pn=1) #is this needed?
    ...
    #pm.makeIdentity(target_obj, apply=True, scale=True, rotate=True, translate=True)
